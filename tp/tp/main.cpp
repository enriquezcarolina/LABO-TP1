...
int main()
{
	...
	cVehiculo* v = new cVehiculo(c, 1000,40 ,20, 30000, "fiat", "1998", "uno", 30, "AAB 981");
	cVehiculo* v1 = new cVehiculo(c3, 1500, 60, 30, 1000000, "toyota", "2018", "corolla", 33, "AB 123 CD");
	cVehiculo* v2 = new cVehiculo(c4, 950, 45, 20, 100000, "renault", "2020", "kangoo", 30, "DAB 781");
